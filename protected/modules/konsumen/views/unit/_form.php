	...
	<table>		
		...
		<tr>
			...
			<td>
				...
				elseif ($role=='perencanaan' and $model->status=='published') {
					$statuss = array('published'=>'published','hold'=>'hold');	
				}
				elseif ($role=='pemasaran' and $model->status=='released') {
					$statuss = array('released'=>'released','published'=>'published');		
				}
				elseif ($role=='pemasaran' and $model->status=='published') {
					$statuss = array('published'=>'published','sold'=>'sold');		
				}
