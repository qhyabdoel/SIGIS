...
class Absen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NIK, Tanggal, Jam_Masuk, Jam_Keluar, Jam_Kerja', 'required'),
			array('NIK', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('No, NIK, Tanggal, Jam_Masuk, Jam_Keluar, Jam_Kerja', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Jam_Kerja',$this->Jam_Kerja,true);
