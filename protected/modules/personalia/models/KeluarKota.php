...
/**
 * This is the model class for table "luar_kota".
 *
 * The followings are the available columns in table 'luar_kota':
 * @property integer $Id
 ...
 */
class KeluarKota extends CActiveRecord
{
	/**
	 ...
	 * @return KeluarKota the static model class
	 */
	...
	public function afterSave(){
		...
		for($i=0;$i<=$timespan;$i++){ 
			...
			$absensi->Ketidakhadiran 	= 'ke luar kota';
			$absensi->save();						

			$tanggal = date('Y-m-d',strtotime($tanggal)+86400);
		}	

		KeluarKotaSementara::model()->find()->delete();	
	}
}
