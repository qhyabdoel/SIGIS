...
/**
 * This is the model class for table "terlambat".
 *
 * The followings are the available columns in table 'terlambat':
 * @property integer $Id
 ...
 */
class Terlambat extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, NIK, Nama, Departmen, Jabatan, Tanggal_Awal, Tanggal_Akhir, Terlambat_Bulanan, Lama_Terlambat, Total_Terlambat_Bulanan, Alasan, Masa_Kerja', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Terlambat the static model class
	 */
