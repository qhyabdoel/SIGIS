...
class TbPenggajianController extends Controller{
	...
	public function actionTes(){
		$kasbon 					= new TbKasbon;
		$kasbon->NIK 				= 15;
		$kasbon->pengajuan_kasbon 	= 150000;
		$kasbon->besar_potongan 	= 177000;
		$kasbon->keterangan 		= "okay";
		$kasbon->save();
	}
	...
	public function actionSlip(){
		...
		if(isset($_REQUEST['action'])){
			if($_REQUEST['action']=='ok'){
				...
				$this->redirect(array('/site/bulanan'));
			}
		}
		...
		{	
			...
			foreach($penggajians as $row){$tunjangan_jabatan = $tunjangan_jabatan+$row->tunjangan_jabatan;}
