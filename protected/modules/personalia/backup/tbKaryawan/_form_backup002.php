...
<?php if($confirm==1){ 
	if(isset($button)&&$button=='update'){
		?><label>Masukan password manager untuk menyimpan data!</label><?php
	}
	elseif(isset($button)&&$button!='update'){
		?><label>Masukan password manager untuk menghapus data!</label><?php
	}
	else{
		?><label>Masukan password manager untuk menyimpan data!</label><?php
	} ?>
...
<?php } ?>
	...
	<tr>
		...
		<td>
			<?php echo $form->dropDownList($model,'Jenis_ID',
			
			array('KTP'=>'KTP','SIM'=>'SIM','PASPOR'=>'PASPOR'),
	...
	<tr>
		...
		<td>
			<?php echo $form->dateField($model,'Tanggal_Masuk',array('value'=>date('Y-m-d'),'disabled'=>'true')); ?>
			<?php echo $form->dateField($model,'Tanggal_Masuk',array('value'=>date('Y-m-d'),'hidden'=>'true')); ?>
	...
	<tr>
		...
		<td>
			<?php echo $form->textArea($model,'Alamat_Rumah'); ?>
	...
	<tr>
		...
		<td>
			<?php echo $form->dateField($model,'Kontrak_Awal',
										
										array('style'=>'width:170px','id'=>'kontrak_awalField','disabled'=>'true')
			
					); 
			?>
			<?php echo $form->dateField($model,'Kontrak_Awal',array('id'=>'kontrak_awalField2','hidden'=>'true')); ?>
	...
	<tr>
		<td></td>
		<td>
			<?php echo $form->dateField($model,'Kontrak_Akhir',array('style'=>'width:170px','id'=>'kontrak_akhirField','disabled'=>'true')); ?>
			<?php echo $form->dateField($model,'Kontrak_Akhir',array('id'=>'kontrak_akhirField2','hidden'=>'true')); ?>
