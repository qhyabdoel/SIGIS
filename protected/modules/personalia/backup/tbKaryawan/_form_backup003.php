...
<?php } ?>
	...
	<tr>
		...
		<td>
			<?php echo $form->dateField($model,'Kontrak_Awal',array('id'=>'kontrak_awalField','disabled'=>'true')); ?>
	...
	<tr>
		<td></td>
		<td>
			<?php echo $form->dateField($model,'Kontrak_Akhir',array('id'=>'kontrak_akhirField','disabled'=>'true')); ?>
