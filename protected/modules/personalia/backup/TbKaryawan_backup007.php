...
class TbKaryawan extends CActiveRecord{
	...
	public function getProgressive($proyek,$awal,$akhir){		
		...
		$persentase1 		= $ketentuan_pph->persentase_tarif_1;
		$persentase2 		= $ketentuan_pph->persentase_tarif_2;
		$persentase3 		= $ketentuan_pph->persentase_tarif_3;
		$persentase4 		= $ketentuan_pph->persentase_tarif_4;
	...
	public function getDenda_npwp($proyek,$awal,$akhir){
		...
		if($this->No_NPWP!=''){
			...
			if($take_home_pay>=$awal and $take_home_pay<=$akhir) 
				$result = $take_home_pay*$persentase1;
			
			if($take_home_pay>=$akhir) $result = $take_home_pay*$persentase1;
		}
