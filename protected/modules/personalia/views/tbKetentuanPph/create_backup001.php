...
<table>
	...
	<tr>
		...
		<td width="210px">			
			<input name="ptkp2s[<?php echo $index; ?>][tarif]" value="<?php echo $ptkp->tarif; ?>">
			<input name="ptkp2s[<?php echo $index; ?>][id]" value="<?php echo $ptkp->id; ?>" hidden>
			<span colspan="3" style="color:#C00000;" id="errorCell">
				<?php echo $ptkp_tarif_errors[$ptkp->id]; ?>
			</span>
		</td>
	</tr>
...
$('#fieldTake_home_pay_2').change(function(){	
