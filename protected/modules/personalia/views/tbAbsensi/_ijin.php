...
<table>
	...
	<tr>
		...
		<td>			
			<?php echo $form->textField($ijin,'Ijin_Bulanan',array('disabled'=>'true')); ?>
			<?php echo $form->textField($ijin,'Ijin_Bulanan',array('hidden'=>'true')); ?>
	...
	<tr>
		...
		<td>			
			<?php echo $form->textField($ijin,'Total_Ijin_Bulanan',array('disabled'=>'true','id'=>'total_ijin_bulananField2','value'=>12)); ?>
			<?php echo $form->textField($ijin,'Total_Ijin_Bulanan',array('hidden'=>'true','id'=>'total_ijin_bulananField','value'=>12)); ?>
