...
<?php $form = $this->beginWidget('CActiveForm', array('id'=>'tb-verifikasi_absen-form','htmlOptions'=>array('enctype'=>'multipart/form-data'),'enableAjaxValidation'=>false)); ?>
...
<?php echo $form->textField($lembur,'Nama',array('value'=>$nama,'hidden'=>'true')); ?>
<?php echo $form->textField($keluarkota,'Nama',array('value'=>$nama,'hidden'=>'true')); ?>
...
<?php echo $form->textField($lembur,'Masa_Kerja',array('value'=>$masa_kerja,'hidden'=>'true')); ?>
<?php echo $form->textField($keluarkota,'Masa_Kerja',array('value'=>$masa_kerja,'hidden'=>'true')); ?>
...
<?php echo $form->textField($lembur,'Jabatan',array('value'=>$karyawan_jabatan,'hidden'=>'true')); ?>
<?php echo $form->textField($keluarkota,'Jabatan',array('value'=>$karyawan_jabatan,'hidden'=>'true')); ?>
...
<?php echo $form->textField($lembur,'Departmen',array('value'=>$karyawan_departemen,'hidden'=>'true')); ?>
<?php echo $form->textField($keluarkota,'Departmen',array('value'=>$karyawan_departemen,'hidden'=>'true')); ?>
...
$cuti_data 	= array(
	'form'=>$form,'nik'=>$nik,'cuti'=>$cuti,'role'=>$role,'Cuti_Terpakai'=>$Cuti_Terpakai,'Sisa_Cuti'=>$Sisa_Cuti,
	'durasi_cuti'=>$durasi_cuti
);

$sakit_data 		= array('form'=>$form,'nik'=>$nik,'sakit'=>$sakit,'durasi_sakit'=>$durasi_sakit,'surat'=>$surat,'surats'=>$surats);
$ijin_data 			= array('form'=>$form,'nik'=>$nik,'ijin'=>$ijin,'lama_ijins_sum'=>$lama_ijins_sum,'role'=>$role);
$terlambat_data		= array('form'=>$form,'nik'=>$nik,'terlambat'=>$terlambat,'lama_terlambats_sum'=>$lama_terlambats_sum,'role'=>$role);
$lembur_data		= array('form'=>$form,'nik'=>$nik,'lembur'=>$lembur,'role'=>$role);
$keluarkota_data	= array('form'=>$form,'nik'=>$nik,'keluarkota'=>$keluarkota,'role'=>$role,'durasi_keluarkota'=>$durasi_keluarkota);
...
$this->widget(
	...
	array(
	  	'tabs' => array(            
			...
			'lembur' 			=> array('content'=>$this->renderPartial('_lembur',$lembur_data,TRUE)),
			'Keluar Kota' 		=> array('content'=>$this->renderPartial('_keluarkota',$keluarkota_data,TRUE))
	  	),
