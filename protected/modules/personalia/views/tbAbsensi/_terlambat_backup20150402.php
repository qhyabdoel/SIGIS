...
<table>
	...
	<tr>
		...
		<td>
			<input id="terlambat_bulananField" value="<?php echo $lama_terlambats_sum; ?>" disabled>
	...
	<tr>
		...
		<td>			
			<?php echo $form->textField($terlambat,'Total_Terlambat_Bulanan',array('disabled'=>'true','id'=>'total_terlambat_bulananField2')); ?>
			<?php echo $form->textField($terlambat,'Total_Terlambat_Bulanan',array('hidden'=>'true','id'=>'total_terlambat_bulananField')); ?>
