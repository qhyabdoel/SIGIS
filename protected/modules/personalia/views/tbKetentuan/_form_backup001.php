...
<?php } ?>
	...
	<table>
		<tr>
			...
			<td>
				<input value="<?php echo $nik; ?>" disabled="true">
				<?php echo $form->textField($model,'id',array('hidden'=>'true','value'=>$nik)); ?>
	...
	if($disable=="true")
	{
		echo $form->textField($model,'active',array('hidden'=>'true','id'=>'activeField','value'=>'0')); 
	}
	else
	{
		echo $form->textField($model,'active',array('hidden'=>'true','id'=>'activeField')); 
	}
	?>
