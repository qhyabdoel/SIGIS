...
<?php } ?>
	...
	<table>
		<tr>			
			...
			<td>
				<?php $golongans['add value'] = 'add value'; ?>
		...
		<tr>
			...
			<td>
				<?php echo $form->dropDownList($model,'kode_jabatan',$jabatans,array('style'=>'width:172px;')); ?>
		...
		<tr>
			...
			<td>				
				<?php $masa_kerjas['add value'] = 'add value'; ?>
...
$('#masa_kerjaField').click(function(){
	if($(this).val()=='add value'){
		window.location.href = $('#add_valueLink').val();
	}
});

$('#golonganField').click(function(){
	if($(this).val()=='add value'){
		window.location.href = $('#add_valueLinkGolongan').val();
	}
});
