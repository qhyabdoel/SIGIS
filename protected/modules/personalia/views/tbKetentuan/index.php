...
$href  = Yii::app()->createUrl('personalia/TbKetentuan/request_verifikasi');
$href2 = Yii::app()->createUrl('personalia/TbKetentuan/verify');

?>

<input id="counterMessage" hidden>
<input id="requestUrl2" value="<?php echo $href2; ?>" hidden>
