	...
	<table>
		<tr>			
			...
			<td>
				...
				$golongans['edit'] = 'edit'; 
				?>
				<?php echo $form->dropDownList($model,'id_golongan',$golongans,array('id'=>'golonganField','style'=>'width:174px;')); ?>
		...
		<tr>
			...
			<td>
				<?php echo $form->dropDownList($model,'kode_department',$departmens,array('style'=>'width:174px;')); ?>
		...
		<tr>
			...
			<td>				
				...
				?>
				<?php echo $form->dropDownList($model,'Masa_Kerja',$masa_kerjas,array('id'=>'masa_kerjaField','style'=>'width:174px;')); ?>
...
if(isset($update)){	
	...
	$href3 = Yii::app()->createUrl('personalia/TbGolongan/index?ketentuan=');
	$href4 = Yii::app()->createUrl('personalia/TbMasaKerjaKetentuan/index?ketentuan=');
}
