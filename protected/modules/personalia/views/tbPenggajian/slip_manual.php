...
{	
	...
	if($jumlah_kehadiran!='') {
		$premi_hadir = $premi_hadir-$premi_hadir*(($maksimal_kehadiran-$jumlah_kehadiran)/10);}

		if($jumlah_kehadiran<$maksimal_kehadiran) $bonus_hadir = 0;
	}
else
{	
...
<table>
	...
	<tr>
		<th>Maksimal Jumlah Kehadiran</th>
		
		<?php if($final=='false'){
			?><td>: <input name="maksimal_kehadiran" value="<?php echo $maksimal_kehadiran; ?>" style="width:50px;"></td><?php
		}
		else{
			?><td>: <?php echo $maksimal_kehadiran; ?></td><?php
		} ?>		
	</tr>
	...
	<tr>
		...
		<?php if($final=='false'){
			?><td>: <input name="jumlah_kehadiran" value="<?php echo $jumlah_kehadiran; ?>" style="width:50px;"></td><?php
		}
		else{
			?><td>: <?php echo $jumlah_kehadiran; ?></td><?php	
		} ?>		
	</tr>
</table>
