...
class ClusterController extends Controller
{
	...
	{
		$this->state 	= 'Cluster Baru';
		$model 			= new Cluster;
		$projects 		= CHtml::listData(Project::model()->findAll(),'id','project_name');
	 ...
	 * @param Cluster $model the model to be validated
	 */
